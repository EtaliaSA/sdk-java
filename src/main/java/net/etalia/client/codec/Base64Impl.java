package net.etalia.client.codec;
...
class Base64Impl {
	...
	public static void encode(java.nio.ByteBuffer raw,
		...
		while (raw.hasRemaining()) {
			...
			raw.get(raw3, 0, rem);
			Base64Impl.encode3to4(enc4, raw3, rem, Base64Impl.NO_OPTIONS);
			encoded.put(enc4);
		} // end input remaining
	}
	...
	public static String encodeObject(java.io.Serializable serializableObject,
		...
		try {
			...
			b64os = new Base64Impl.OutputStream(baos, ENCODE | options);
			if ((options & GZIP) != 0) {
				// Gzip
	...
	public static byte[] encodeBytesToBytes(byte[] source, int off, int len,
		...
		if ((options & GZIP) != 0) {
			java.io.ByteArrayOutputStream baos = null;
			java.util.zip.GZIPOutputStream gzos = null;
			Base64Impl.OutputStream b64os = null;
	...
	public static byte[] decode(byte[] source) throws java.io.IOException {
		byte[] decoded = null;
		// try {
		decoded = decode(source, 0, source.length, Base64Impl.NO_OPTIONS);
		// } catch( java.io.IOException ex ) {
		// assert false :
	...
	public static void encodeToFile(byte[] dataToEncode, String filename)
		...
		Base64Impl.OutputStream bos = null;
		try {
			bos = new Base64Impl.OutputStream(new java.io.FileOutputStream(
					filename), Base64Impl.ENCODE);
	...
	public static byte[] decodeFromFile(String filename)
		...
		Base64Impl.InputStream bis = null;
		try {
			...
			// Open a stream
			bis = new Base64Impl.InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(file)), Base64Impl.DECODE);
	...
	public static String encodeFromFile(String filename)
		...
		try {
			...
			// Open a stream
			bis = new Base64Impl.InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(file)), Base64Impl.ENCODE);
	...
	public static void encodeFileToFile(String infile, String outfile)
		...
		String encoded = Base64Impl.encodeFromFile(infile);
	...
	public static void decodeFileToFile(String infile, String outfile)
		...
		byte[] decoded = Base64Impl.decodeFromFile(infile);
		java.io.OutputStream out = null;
		try {
			out = new java.io.BufferedOutputStream(
					new java.io.FileOutputStream(outfile));
	...
	/**
	 * A {@link Base64Impl.InputStream} will read data from another
	...
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link Base64Impl.InputStream} in DECODE mode.
		 * 
		 * @param in
		...
		/**
		 * Constructs a {@link Base64Impl.InputStream} in either ENCODE or
		 * DECODE mode.
		 * <p>
		 * Valid options:
		 * 
		 ...
		 * @param options
		 *            Specified options
		 * @see Base64Impl#ENCODE
		 * @see Base64Impl#DECODE
		 * @see Base64Impl#DO_BREAK_LINES
		 * @since 2.0
		 */
	...
	/**
	 * A {@link Base64Impl.OutputStream} will write data to another
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link Base64Impl.OutputStream} in ENCODE mode.
		 * 
		 * @param out
		...
		/**
		 * Constructs a {@link Base64Impl.OutputStream} in either ENCODE or
		 * DECODE mode.
		 * <p>
		 * Valid options:
		 * 
			...
			// Else, Decoding
				...
				if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
					...
					if (position >= bufferLength) { // Enough to output.
						...
						int len = Base64Impl.decode4to3(buffer, 0, b4, 0,
								options);
						out.write(b4, 0, len);
						position = 0;
					} // end if: enough to output
